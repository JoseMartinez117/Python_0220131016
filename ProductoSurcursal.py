print("Digite los nombres de los productos")
p=str(input("#1: "))
p1=str(input("#2: "))
p2=str(input("#3: "))
p3=str(input("#4: "))
...
print("Se recaudo "+str(rcsurcursal1)+" de la surcusal 1")
print("Se recaudo "+str(rcsurcursal2)+" de la surcusal 2")
print("Se recaudo "+str(rcsurcursal3)+" de la surcusal 3")
print("Se recaudo "+str(rcsurcursal4)+" de la surcusal 4")
...
elif rcsurcursal4>rcsurcursal1 and rcsurcursal4>rcsurcursal2 and rcsurcursal4>rcsurcursal3:
